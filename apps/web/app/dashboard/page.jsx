  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-slate-900">My Forms</h2>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-24 bg-white border border-slate-200 rounded-xl shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900">No forms created yet</h3>
            ...
            <Card key={form.id} className="hover:shadow-md transition-shadow flex flex-col">
              <CardHeader>
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider ${form.visibility === 'PUBLIC' ? 'bg-green-100 text-green-700' : 'bg-slate-100 text-slate-600'}`}>
                    {form.visibility}
                  </span>
                </div>
