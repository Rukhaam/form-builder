      ...
      <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-4 max-w-sm text-sm leading-6 text-slate-600">
            Beautiful form creation, publishing, and response analytics for tiny
        ...
        <div>
          <h2 className="text-sm font-medium uppercase text-slate-950">
            Explore
          </h2>
          <div className="mt-4 grid gap-3 text-sm font-medium text-slate-600">
            <Link href="/forms" className="active:text-slate-950">
              Public forms
            </Link>
            <Link href="/pricing" className="active:text-slate-950">
              Pricing
            </Link>
            <Link href="/dashboard/analytics" className="active:text-slate-950">
              Analytics
            </Link>
            <Link
              href="/dashboard/editor/new"
              className="active:text-slate-950"
            >
              Create form
            </Link>
          </div>
